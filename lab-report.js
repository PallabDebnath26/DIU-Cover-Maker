window.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('lab-report').addEventListener('submit', function (e) {
    e.preventDefault();

    const data = {
      department: document.getElementById('department').value,
      faculty: document.getElementById('faculty').value,
      experimentNo: document.getElementById('experimentNo').value,
    ...
    sessionStorage.setItem('labReportData', JSON.stringify(data));
    window.location.href = 'lab-report-view.html';
  });
});
